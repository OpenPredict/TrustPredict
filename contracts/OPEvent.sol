...
contract OPEvent is Ownable {
    ...
    address constant OPUSD = 0xB876a52ABD933a02426C31d8231e9B9352864214;
        ...
        public 
    {
        ...
        oracle = new Oracle(endTime + 2 minutes, _priceAggregator); // give the oracle callback some leeway
