...
// ChainLink Kovan price aggregators.
contract PriceAggregators {
    ...
    mapping(address => Pairing) priceAggregators;
    ...
    modifier validPriceAggregator(address _priceAggregator) {
        ...
        require(pairing.set, 
                "PriceAggregators: Invalid Price Aggregator address.");
        _;
    }
    ...
    function getPriceAggregatorPairing(address _priceAggregator) 
